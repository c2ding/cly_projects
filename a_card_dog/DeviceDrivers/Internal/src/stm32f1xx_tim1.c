...
{
	//__HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_4, p_datum*(ADVANCED_TIM_PERIOD/100)); //PWM重新配置，周期为1000，高电平持续时间为i
...
//--------------------------------------------------------------------------------
#if 0
	__HAL_RCC_TIM1_CLK_DISABLE(); // 基本定时器外设时钟禁用
...
//--------------------------------------------------------------------------------
	...
	//HAL_TIMEx_ConfigBreakDeadTime(&htim1, &sBreakDeadTimeConfig); //互补输出设置
//--------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------
	...
	//HAL_TIMEx_PWMN_Start(&htim1,TIM_CHANNEL_1); //使能互补输出
